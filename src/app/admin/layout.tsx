...
const adminNav = [
  ...
  { label: "בלוג", href: "/admin/blog", icon: "✍️", color: RAINBOW_COLORS[3] }, // green
  { label: "אירועים", href: "/admin/events", icon: "📅", color: RAINBOW_COLORS[4] }, // blue
  { label: "מנהלים", href: "/admin/admins", icon: "👥", color: RAINBOW_COLORS[6] }, // violet
];
